...
// door.offset.x = 0.2;
// door.offset.y = -0.4;
// door.offset.set(0.2, -0.4);
// 设置贴图的旋转
// door.rotation = Math.PI / 4;   // 默认是按照左下角旋转
// door.center.set(0.5, 0.5);     // 按照中心点旋转
// 设置重复
// door.repeat.set(2, 3);  // 水平重复两次，垂直重复三次
// door.wrapS = THREE.MirroredRepeatWrapping;  // 水平是按照镜像的包裹
// door.wrapT = THREE.RepeatWrapping;  // 垂直是按照无限重复的包裹
// 贴图的背景图片的设置
door.minFilter = THREE.NearestFilter;  // 显示的空间小于贴图的本身大小的时候怎么显示图片， 详细见文档
door.magFilter = THREE.LinearFilter;   // 显示的空间大于贴图的本身大小的时候怎么显示图片， 详细见文档
